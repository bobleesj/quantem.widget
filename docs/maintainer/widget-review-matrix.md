...
| Browser WebGPU | `js/webgpu-volume.ts`, generated `js/.generated/engine/*` from `quantem.gpu.webgpu`, `web/src/utils/*`, Show4DSTEM/ShowEDS frontend paths | Adapter detection, CPU fallback, WGSL parity, memory ownership, browser/export split | WebGPU-focused pytest/Vitest plus browser signoff on supported hardware |
